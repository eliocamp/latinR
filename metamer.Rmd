...
authors:
   - firstname: Elio
     ...
     country: Argentina
     affil: Centro de Investigaciones del Mar y la Atmósfera - CONICET
...
El paquete \CRANpkg{metamer} implementa el algoritmo de @matejka2017 para generar metámeros a partir de un dataset y una transformación estadística que debe preservarse. Al ser completamente genérico, permite ilustrar el metamerismo de cualquier transformación. Por ejemplo, este comando crea metámeros preservando los primeros 4 momentos. 

```{r, eval = FALSE}
library(metamer)
metameros <- metamerize(data.frame(x = rnorm(100)), 
                        preserve = moments_n(1:4))
```
